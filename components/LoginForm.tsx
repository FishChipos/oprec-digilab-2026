...
export default function LoginForm() {
	...
	return (
		<div className="overflow-auto flex flex-col justify-start shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
			...
			<form className="my-8" onSubmit={handleSubmit}>
				...
				<button
					className="group/btn relative cursor-pointer block h-10 w-full rounded-md bg-linear-to-br from-black to-neutral-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset] disabled:opacity-50"
					type="submit"
					disabled={emailLoginLoading || googleSignInLoading}
				>
				...
				<div className="flex flex-col cursor-pointer items-center space-y-4">
					...
					<p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
						...
						<Link
							href="/signup"
							className="font-semibold text-neutral-800 dark:text-neutral-300 hover:underline"
						>
							Sign up
						</Link>
					</p>
